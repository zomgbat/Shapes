...
"Flet victus, victor interiit. - Latin proverb",
"Timidi mater non flet. - Latin proverb",
...
"A bad peace is even worse than a war. - Tacitus",
...
"Nobody is driven into war by ignorance, and no one who thinks he will gain anything from it is deterred by fear. - Hermocrates",
"Even the bravest cannot fight beyond his strength. - Euripides",
...
"A dead enemy always smells good. - Aulus Vitellius",
...
"If a man does not strike first, he will be first struck. - Athenogoras of Syracuse",
...
"The Spartans do not ask how many enemies but where they are. - Agis II of Sparta",
"Come home with this shield, or upon it. - A Spartan mother equips her son",,
"Who was the first that forged the deadly blade? Of rugged steel his savage soul was made. - Tibullus",
"A small country cannot contend with a great; the few cannot contend with the many; and the weak cannot contend with the strong. - Mencius",
...
"Alta sedent civilis vulnera dextrae. - Lucan",
"It is pleasant, when the sea is high and the winds are dashing the waves about, to watch from the shores the struggles of another. - Lucretius"
  ...
  render() {
    return (
      <div>
        <button className="quotebutton" onClick={this.generateQuote}>Generate Quote</button>
